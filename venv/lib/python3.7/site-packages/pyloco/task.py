        ...
        if targs.calculate:
            for calc in targs.calculate:
                ...
                for lhs, rhs in calc.kwargs.items():
                    self._env[lhs] = teval(rhs, self._env)
...
class OptionTask(Task):
    ...
    def show_installed_tasks(self, tasks):
        installed_tasks = dict((n, t) for n, t in tasks)
        return self._lines("installed tasks", installed_tasks)
